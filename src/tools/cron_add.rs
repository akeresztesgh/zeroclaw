            ...
            Schedule::At { at } => {
                ...
                if at <= now_utc {
                    return Ok(ToolResult {
                        ...
                        output: String::new(),
                        error: Some(format!(
                            "Invalid schedule.at: requested_at={} is not in the future relative to now_utc={}. schedule.at must be future UTC RFC3339. Use prompt field 'utc_rfc3339' as current-time source for this turn.",
                            at.to_rfc3339(),
                            now_utc.to_rfc3339(),
                        )),
                    });
